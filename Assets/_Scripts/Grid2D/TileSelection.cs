...
public class TileSelection
{
    ...
    public TileSelection Chain { get; private set; }

    public TileSelection(Direction direction, int maxDistance=-1, int minDistance=0, int width=0, bool absoluteDirection=false, int collide=0, TileSelection chain=null)
    {
        Direction = direction;
